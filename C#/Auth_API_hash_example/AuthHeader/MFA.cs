    ...
    public class DuoAuth
    {
...

        {
            ...
            var ikey = Environment.GetEnvironmentVariable("integration_key");
             ...
             var stringHeader = Sign(method, host, URL, skey, ikey);

            
            var jsonresponse = new { Authorization = $"{stringHeader["Authorization"]}",
        ...
        static Dictionary<string, string> Sign(string method, string host, string path, string skey, string ikey)
        {
